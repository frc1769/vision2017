...
factory.set_launch('( fdsrc fd=0 ! videoparse width=320 height=180 framerate=30/2 format=16 ! autovideoconvert ! omxh264enc tune=zerolatency is-live=True ! rtph264pay name=pay0 pt=96 )')
